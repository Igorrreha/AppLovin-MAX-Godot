...
opts.Add(EnumVariable('plugin', 'Plugin to build', '', ['', 'AppLovin-MAX-Godot-Plugin']))
...
sources = Glob('AppLovin-MAX-Godot-Plugin/*.cpp')
sources.append(Glob('AppLovin-MAX-Godot-Plugin/*.mm'))
sources.append(Glob('AppLovin-MAX-Godot-Plugin/*.m'))
sources.append(Glob('AppLovin-MAX-Godot-Plugin/Categories/*.cpp'))
sources.append(Glob('AppLovin-MAX-Godot-Plugin/Categories/*.mm'))
sources.append(Glob('AppLovin-MAX-Godot-Plugin/Categories/*.m'))
